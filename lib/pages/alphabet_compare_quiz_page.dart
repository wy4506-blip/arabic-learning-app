...
class AlphabetCompareQuizPage extends StatefulWidget {
  const AlphabetCompareQuizPage({super.key});

  @override
  State<AlphabetCompareQuizPage> createState() =>
      _AlphabetCompareQuizPageState();
}

class _AlphabetCompareQuizPageState extends State<AlphabetCompareQuizPage> {
  ...
  Future<void> _loadQuestions() async {
    ...
    if (mounted) {
      setState(() {
        _questions = AlphabetQuizData.compareQuestions;
        _isLoading = false;
      });
    }
  }
  ...
  void _showResultDialog() {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Text('第 2 级完成', style: text.titleLarge),
        content: Text(
