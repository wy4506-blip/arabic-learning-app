...
- Stage: Stage D
- Working title: Study A New Phrase By Yourself
- Core objective from planning docs: Independently study one new short Arabic phrase with a repeatable phrase-learning process.
- Recording instruction: do not record final voiceover for this lesson yet.

## Available Planning Source
...
- Keep the file path and package slug stable.
